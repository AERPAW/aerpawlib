...
```bash
aerpawlib --vehicle drone --conn udpin://127.0.0.1:14570 --no-aerpaw-environment \
...
```bash
aerpawlib --vehicle drone --conn udpin://127.0.0.1:14580 --no-aerpaw-environment \
...
```bash
aerpawlib --vehicle none --skip-init --no-aerpaw-environment \
