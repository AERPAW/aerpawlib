...
There are two versions of the API: v1 and v2. Version 1 contains the exact same API as the original aerpawlib and fully-featured API.  Version 2 is a newer, beta API design focused on simplifying the API and improving performance. It is not yet completely ready for production but works for most use cases. 
