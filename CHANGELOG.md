...
Bug fixes for timed `set_velocity` race conditions and duration handling, latitude-scaled `Coordinate.bearing`, checkpoint URL encoding, and `ExternalProcess` stream redirection.
