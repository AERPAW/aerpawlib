...
- aerpawlib.v2.zmqutil: v2 implementation
...
warnings.warn(
    "Importing from aerpawlib.zmqutil is deprecated. Use 'from aerpawlib.v1.zmqutil import ...' or 'from aerpawlib.v2.zmqutil import ...' instead.",
    DeprecationWarning,
    stacklevel=2,
)
