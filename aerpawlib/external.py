...
warnings.warn(
    "Importing from aerpawlib.external is deprecated. Use 'from aerpawlib.v1.external import ...' or 'from aerpawlib.v2.external import ...' instead.",
    DeprecationWarning,
    stacklevel=2,
)

# Re-export everything from v1 for backward compatibility
from .v1.external import *  # noqa: E402,F403
