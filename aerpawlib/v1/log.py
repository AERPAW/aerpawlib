"""
Logging utilities for aerpawlib v1.
...
class LogComponent(Enum):
    """Predefined logging components for v1 categorized logging."""
...
def configure_logging(
    ...
    """
    Configure logging for aerpawlib v1.
    ...
    root_logger = logging.getLogger("aerpawlib.v1")
