...
warnings.warn(
    "Importing from aerpawlib.vehicle is deprecated. Use 'from aerpawlib.v1.vehicle import ...' or 'from aerpawlib.v2.vehicle import ...' instead.",
    DeprecationWarning,
    stacklevel=2,
)

# Re-export everything from v1 for backward compatibility
from .v1.vehicle import *  # noqa: E402,F403
